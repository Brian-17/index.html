  ...
  <div className="bg-[#050507] text-white min-h-screen">
    <nav className="flex justify-between items-center px-6 md:px-12 py-5 max-w-[1400px] mx-auto">
      <div className="flex items-center gap-2.5">
        ...
        <span className="font-semibold">BULLSEYE FX</span>
      </div>
    ...
    <section className="max-w-[1400px] mx-auto px-6 md:px-12 pt-20 text-center">
      <div className="inline-flex items-center gap-2 bg-[#121214] border border-white/10 px-4 py-1.5 rounded-full text-[11px] text-gray-300">
        <span className="w-1.5 h-1.5 bg-green-400 rounded-full animate-pulse"></span> AI Trading with MT5 Connection, Cloud Bots & Free VPS
      </div>
      ...
      <div className="mt-20 bg-[#101012] border border-white/10 rounded-[32px] p-3 max-w-5xl mx-auto">
        <div className="bg-black rounded-[20px] h-[360px] flex items-center justify-center border border-white/5 font-mono text-[11px] text-gray-500">
          ◎ BULLSEYE SNIPER • LIVE • NAS100 M15 • BULLISH BIAS ✓ • BUY @ 67420 ✓
        </div>
      </div>
    </section>
  </div>
